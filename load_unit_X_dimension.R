...
x_dim_loadUnit = subset(loadUnit, select = -c(load_unit_y_dim, load_unit_z_dim, load_unit_weight, packagings_per_load_unit,
...
# Association between load_unit_x_dim & other qualitative variables
par(mfrow=c(2,2))
boxplot(load_unit_x_dim~packaging_raw_material_name, col="cadetblue4")
boxplot(load_unit_x_dim~packaging_is_oneway, col="cadetblue4")
boxplot(load_unit_x_dim~packaging_is_special, col="cadetblue4")

effect_rawMaterial = aov(load_unit_x_dim~packaging_raw_material_name)
summary(effect_rawMaterial)
effect_packagingSpecial = aov(load_unit_x_dim~packaging_is_special)
summary(effect_packagingSpecial)
effect_packagingOneWay = aov(load_unit_x_dim~packaging_is_oneway)
summary(effect_packagingOneWay)


# Association between load_unit_x_dim & other quantitative variables
...
cor(load_unit_x_dim, num_var)

par(mfrow=c(3,3))
plot(load_unit_x_dim~packaging_z_dim, col = 'cadetblue4', main = 'Scatterplot for load_unit_x_dim and packaging_z_dim')
abline(lm(load_unit_x_dim~packaging_z_dim), col = 'red')

plot(load_unit_x_dim~packaging_volume, col = 'cadetblue4', main = 'Scatterplot for load_unit_x_dim and packaging_volume')
abline(lm(load_unit_x_dim~packaging_volume), col = 'red')

plot(load_unit_x_dim~packaging_weight, col = 'cadetblue4', main = 'Scatterplot for load_unit_x_dim and packaging_weight')
abline(lm(load_unit_x_dim~packaging_weight), col = 'red')

plot(load_unit_x_dim~packaging_x_dim, col = 'cadetblue4', main = 'Scatterplot for load_unit_x_dim and packaging_x_dim')
abline(lm(load_unit_x_dim~packaging_x_dim), col = 'red')

plot(load_unit_x_dim~packaging_load_capacity, col = 'cadetblue4', main = 'Scatterplot for load_unit_x_dim and packaging_load_capacity')
abline(lm(load_unit_x_dim~packaging_load_capacity), col = 'red')

plot(load_unit_x_dim~packaging_y_dim, col = 'cadetblue4', main = 'Scatterplot for load_unit_x_dim and packaging_y_dim')
abline(lm(load_unit_x_dim~packaging_y_dim), col = 'red')

plot(load_unit_x_dim~products_per_packaging, col = 'cadetblue4', main = 'Scatterplot for load_unit_x_dim and products_per_packaging')
abline(lm(load_unit_x_dim~products_per_packaging), col = 'red')
...
LinearModel1 = lm(load_unit_x_dim~., data = train)
summary(LinearModel1)
pred_linearModel1 = predict(LinearModel1, val)
perform_linearModel1 = acc_error(val$load_unit_x_dim, pred_linearModel1)
...
LinearModel2 = lm(load_unit_x_dim~., data = train)
summary(LinearModel2)
pred_linearModel2 = predict(LinearModel2, val)
perform_linearModel2 = acc_error(val$load_unit_x_dim, pred_linearModel2)
...
train = x_dim_loadUnit[split ==1, ]
val = x_dim_loadUnit[split == 2,]
LinearModel3 = lm(load_unit_x_dim~., data = train)
summary(LinearModel3)
pred_linearModel3 = predict(LinearModel3, val)
perform_linearModel3 = acc_error(val$load_unit_x_dim, pred_linearModel3)
...
train = x_dim_loadUnit[split ==1, ]
val = x_dim_loadUnit[split == 2,]
LinearModel4 = lm(load_unit_x_dim~., data = train)
summary(LinearModel4)
pred_linearModel4 = predict(LinearModel4, val)
perform_linearModel4 = acc_error(val$load_unit_x_dim, pred_linearModel4)
...
train = x_dim_loadUnit[split ==1, ]
val = x_dim_loadUnit[split == 2,]
treeModel1 = rpart(load_unit_x_dim~. , data = train, control = rpart.control(cp = 0.0001))
...
perform_treeModel1_pruned = acc_error(val$load_unit_x_dim, pred_treeModel1_pruned)
perform_treeModel1_pruned
printcp(treeModel1_pruned)

#prune again for better splits
treeModel2_pruned=prune(treeModel1_pruned, cp = 0.00085896)
pred_treeModel2_pruned = predict(treeModel2_pruned, val)
perform_treeModel2_pruned = acc_error(val$load_unit_x_dim, pred_treeModel2_pruned)
...
rpart.plot(treeModel2_pruned,type=4,extra="auto",
           main="Load Unit x Dimension (in numerical)")
printcp(treeModel2_pruned)
